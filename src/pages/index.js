      ...
      <div>
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            The Increase Your Impact Podcast with Justin Su'a is for leaders --
            that means you! Each episode is aimed to provide you with insights,
            principles and strategies to help you lead yourself so that you can
            lead others at work, home, and in life.
          </div>
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl" />
        ...
        <div className="mt-16 md:mt-20 pl-4 pr-4 max-w-2xl m-auto lg:max-w-3xl lg:pl-0 lg:pr-0 lgx:max-w-960 xl:max-w-5xl">
          ...
          <div className="flex justify-center mt-16 lgx:max-w-960 lgx:mx-12">
            <button
              ...
              className={`${
                albumStyle.footer
              } text-gray-900 font-bold py-3 px-8 rounded`}
            >
              <span>Load More</span>
            </button>
          </div>
